...
public class ViewCart extends AbstractHtmlPageAction {
	...
	public void preValidate() throws Exception {
		...
		Assert.assertTrue("Cart overview link not found",
				HtmlPageUtils.isElementPresent(page, "id('mini-cart-menu')//div[@class='linkButton']/a"));

		// Remember cart overview link.
		viewCartLink = HtmlPageUtils.findSingleHtmlElementByXPath(page,
				"id('mini-cart-menu')//div[@class='linkButton']/a");
	}
