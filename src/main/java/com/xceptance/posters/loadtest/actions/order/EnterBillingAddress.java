...
public class EnterBillingAddress extends AbstractHtmlPageAction {
	 ...
	 */
	public EnterBillingAddress(final AbstractHtmlPageAction previousAction, final Account account,
	...
	public void preValidate() throws Exception {
		...
		Assert.assertTrue("Button to submit billing address not found.",
				HtmlPageUtils.isElementPresent(page, "id('button-add-billing-address')"));
