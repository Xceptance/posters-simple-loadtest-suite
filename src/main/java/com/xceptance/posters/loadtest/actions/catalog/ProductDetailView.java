...
public class ProductDetailView extends AbstractHtmlPageAction {
	...
	public void preValidate() throws Exception {
		...
		productDetailLink = HtmlPageUtils.findHtmlElementsAndPickOne(page,
				"id('productOverview')//div[@class='card-body']/a");
	...
	protected void postValidate() throws Exception {
		...
		Assert.assertTrue("Product description is not there or not in the right presentation.",
		...
		final HtmlElement productPriceElement = HtmlPageUtils.findSingleHtmlElementByID(page,
		...
		Assert.assertTrue("'Add to cart' button is not available",
