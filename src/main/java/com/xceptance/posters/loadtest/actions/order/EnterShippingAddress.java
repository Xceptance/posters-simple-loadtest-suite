...
public class EnterShippingAddress extends AbstractHtmlPageAction {
	 ...
	 * @param address        The address used in the billing form
	 */
	public EnterShippingAddress(final AbstractHtmlPageAction previousAction, final Account account,
	 ...
	 * @param address
	 */
	public EnterShippingAddress(final AbstractHtmlPageAction previousAction, final String timerName,
			final Address address) {
	...
	public void preValidate() throws Exception {
		...
		Assert.assertTrue("Button to submit shipping address not found.",
				HtmlPageUtils.isElementPresent(page, "id('button-add-shipping-address')"));
